...
public class A2Driver {
	...
	public static void main(String[] args) {
		for(int i = 10; i <= 50; i+=10)
		{
			...
			System.out.println("Sum5: 3");
			System.out.println("Sum5:"+A2Work.sum5(3));
			System.out.println("Sum5: 4");
			System.out.println("Sum5:"+A2Work.sum5(4));
			System.out.println("Sum5: 5");
			System.out.println("Sum5:"+A2Work.sum5(5));
